...
#define AFX_CDynamicMemoryDC_H__F666A491_3847_11D3_A58E_00805FC1DE10__INCLUDED_

	class CDynamicMemoryDC : public CDC {
	private:
	...
	public:
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Function Header
		CDynamicMemoryDC(CDC* pDC, CRect rect = CRect(0, 0, 0, 0), BOOL bCopyFirst = FALSE) : CDC(), m_oldBitmap(NULL), m_pDC(pDC)
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		{
		...
		CDynamicMemoryDC* operator->() { return this; }
		
		// Allow usage as a pointer
		operator CDynamicMemoryDC*() { return this; }
	};

#endif
// End CDynamicMemoryDC
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
